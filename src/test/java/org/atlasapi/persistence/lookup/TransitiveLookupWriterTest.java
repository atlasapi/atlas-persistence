...
public class TransitiveLookupWriterTest extends TestCase {
    ...
    public void testWriteNewLookup() {
        ...
        writer.writeLookup(item, ImmutableSet.<Described> of(), ImmutableSet.of(Publisher.BBC));
    ...
    public void testWriteLookup() {
        ...
        writer.writeLookup(paItem, ImmutableSet.<Described> of(), publishers);
        writer.writeLookup(bbcItem, ImmutableSet.<Described> of(), publishers);
        writer.writeLookup(c4Item, ImmutableSet.<Described> of(), publishers);

        // Make items BBC and C4 equivalent.
        writer.writeLookup(bbcItem, ImmutableSet.<Described> of(c4Item), publishers);
        ...
        // equivalent
        writer.writeLookup(paItem, ImmutableSet.<Described> of(bbcItem), publishers);
        ...
        writer.writeLookup(itunesItem, ImmutableSet.<Described> of(), publishers);

        // Make PA equivalent to just Itunes, instead of BBC. PA and Itunes equivalent, BBC and
        // C4 equivalent.
        writer.writeLookup(paItem, ImmutableSet.<Described> of(itunesItem), publishers);
        ...
        writer.writeLookup(paItem, ImmutableSet.<Described> of(c4Item, itunesItem), publishers);
    ...
    private void hasEquivs(Content id, Content... transitiveEquivs) {
        LookupEntry entry = Iterables.getOnlyElement(store.entriesFor(ImmutableList.of(id.getCanonicalUri())));
    ...
    public void testBreakingEquivs() {
        ...
        writer.writeLookup(left, ImmutableSet.<Described>of(), publishers);
    ...
    public void testDoesntWriteEquivalentsForContentOfIgnoredPublishers() {
        ...
        writer.writeLookup(c4Item, ImmutableSet.<Described> of(), ImmutableSet.of(Publisher.C4));
    ...
    public void testDoesntBreakEquivalenceForContentOfIgnoredPublishers() {
        ...
        writer.writeLookup(fiveItem, ImmutableSet.<Described> of(), ImmutableSet.of(Publisher.FIVE));
