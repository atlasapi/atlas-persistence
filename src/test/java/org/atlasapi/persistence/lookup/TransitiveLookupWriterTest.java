...
public class TransitiveLookupWriterTest extends TestCase {
    ...
    //Tests that trivial lookups are written reflexively for all content identifiers
    public void testWriteNewLookup() {
        ...
        assertEquals(ImmutableSet.of("testUri"), uriEntry.directEquivalents());
    ...
    public void testWriteLookup() {
        ...
        hasDirectEquivs("test1Alias", "test1Uri", "test2Uri");
        ...
        hasDirectEquivs("test2Alias", "test2Uri", "test3Uri", "test1Uri");
        ...
        //Make item 1 equivalent to nothing. Item 1 just reflexive, item 2 and 3 still equivalent.
        writer.writeLookup(item1, ImmutableSet.<Described>of());
        ...
        //Make 1 equivalent to just 4, instead of 2. 1 and 4 equivalent, 2 and 3 equivalent.
        ...
        hasDirectEquivs("test1Alias", "test1Uri", "test4Uri");
        ...
        hasDirectEquivs("test4Alias", "test1Uri", "test4Uri");
        ...
        hasDirectEquivs("test1Alias", "test1Uri", "test3Uri", "test4Uri");
        ...
        hasDirectEquivs("test3Alias", "test1Uri", "test2Uri", "test3Uri");
    ...
    private void hasDirectEquivs(String id, String... directEquivs) {
        LookupEntry uri1Entry = store.entryFor(id);
        assertEquals(ImmutableSet.copyOf(directEquivs), uri1Entry.directEquivalents());
    }
